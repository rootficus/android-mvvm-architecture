...
import com.rf.accessAli.ui.main.di.DaggerFinalFormActivityComponent
import com.rf.accessAli.ui.main.di.FinalFormActivityModule
...
import com.rf.accessAli.utils.Utility.makeTextBold
...
class FinalFormActivity : BaseActivity<ActivityFinalFormBinding>(R.layout.activity_final_form) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // loading the URL
        viewDataBinding?.webview?.loadUrl("https://accessAliminingjk.in/challan/$challanNumber")
    ...
    private fun generateQRCode() {
        val bitmap: Bitmap? =
            generateQRCode(
                "https://accessAliminingjk.in/challan/$challanNumber",
    ...
    private fun initializationDagger() {
        DaggerFinalFormActivityComponent.builder().appComponent(AccessAliSDK.appComponent)
