...
import com.rf.tiffinService.ui.main.di.DaggerDashBoardActivityComponent
import com.rf.tiffinService.ui.main.di.DashBoardActivityModule
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.navigation_for_you -> {
                val bundle = Bundle()
                jumpToAnotherFragment(R.id.navigation_for_you, bundle)
            }
