package com.rf.geolgy.sdkInit.di
...
interface AppComponent {
    ...
    fun getFionDatabase(): GeolgyDatabase
}
...
class AppModule(private val mApplication: Application) {
    ...
    @Provides
    @Singleton
    fun provideFionDatabase(@ApplicationContext context: Context): GeolgyDatabase =
        GeolgyDatabase.getDatabase(context)
