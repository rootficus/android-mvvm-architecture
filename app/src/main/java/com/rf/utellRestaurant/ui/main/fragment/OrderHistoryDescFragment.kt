...
import com.rf.utellRestaurant.databinding.FragmentOrderHistoryDescBinding
...
import com.rf.utellRestaurant.ui.main.di.DaggerOrderHistoryDescFragmentComponent
...
class OrderHistoryDescFragment : BaseFragment<FragmentOrderHistoryDescBinding>(R.layout.fragment_order_history_desc) {
    ...
    companion object {
        fun newInstance(selectedItem: Order): OrderHistoryDescFragment {
            val fragment = OrderHistoryDescFragment()
            val args = Bundle()
    ...
    private fun initializeDagger() {
        DaggerOrderHistoryDescFragmentComponent.builder().appComponent(UtellSDK.appComponent)
