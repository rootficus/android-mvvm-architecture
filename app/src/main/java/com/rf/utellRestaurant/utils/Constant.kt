...
import com.rf.utellRestaurant.utils.Constant.MULTIPART_FORM_TEXT_DATA
...
object Constant {
    ...
    const val PREF_MODEM_CHANGE_STATUS_NOTIFICATION_COUNT =
        "modem_status_change_status_notification_count"
    const val PREF_ADD_BALANCE_MODEM_NOTIFICATION_COUNT = "add_balance_modem_notification_count"
    const val PREF_DEPOSIT_REQUEST_MODEM_NOTIFICATION_COUNT =
        "deposit_request_modem_notification_count"
    const val PREF_WITHDRAWAL_REQUEST_MODEM_NOTIFICATION_COUNT =
        "withdrawals_request_modem_notification_count"
    const val PREF_REFUND_REQUEST_MODEM_NOTIFICATION_COUNT =
        "refund_request_modem_notification_count"

    const val UTELL_ACTION = "utell_action"
