...
class ViewToolTip {
    ...
    companion object {
        fun on(view: View): ViewToolTip {
            return ViewToolTip(
                MyContext(getActivityContext(view.context)),
                view
            )
        }
        ...
        fun on(activity: Activity, view: View?): ViewToolTip {
            return ViewToolTip(MyContext(getActivityContext(activity)), view!!)
        }
        ...
        fun on(
            ...
            return ViewToolTip(
                MyContext(getActivityContext(activity)),
                rootView!!,
                view!!
            )
        }
...
//        private var paddingLeft = 30
        ...
        private var shadowColor = Color.parseColor("#D9D9D9")
    ...
    class MyContext {
        ...
        val window: Window?
            get() = if (activity != null) {
                ...
                } else fragment!!.requireActivity().window
            }
    }
}