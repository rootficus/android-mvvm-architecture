...
import com.rf.baseSideNav.databinding.ActivityDashboardBinding
...
import com.rf.baseSideNav.ui.main.di.DaggerDashBoardActivityComponent
import com.rf.baseSideNav.ui.main.di.DashBoardActivityModule
import com.rf.baseSideNav.ui.main.fragment.DashBoardFragment
import com.rf.baseSideNav.ui.main.fragment.SignInFragment
...
/*
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val toggleButton: ImageButton = findViewById(R.id.imgToggleButton)
    ...
    private fun navigateToDestination(itemId: Int) {
        when (itemId) {
            R.id.nav_dashboard -> navController.navigate(R.id.navigation_dashboard)
            R.id.nav_Signup -> navController.navigate(R.id.navigation_signupFragment)
            R.id.nav_settings -> navController.navigate(R.id.navigation_settingFragment)
            R.id.nav_forgotPass -> navController.navigate(R.id.navigation_forgotPassFragment)
        }
    }
